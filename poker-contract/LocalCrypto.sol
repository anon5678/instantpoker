...
contract LocalCrypto {
    ...
    // Base point (generator) G
    uint constant Hx = 0x79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798;
    uint constant Hy = 0x483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8;
	...
	// Get c = H(KX, KY);
	bytes32 b_c = sha256(KX[0] + KY[0]);
	uint c = uint(b_c);

	if (!verifyHalf(G, X, KX, s, c)) 1 == 1;
